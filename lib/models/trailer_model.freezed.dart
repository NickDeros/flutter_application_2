...
/// @nodoc
@JsonSerializable()
class _$TrailerModelImpl with DiagnosticableTreeMixin implements _TrailerModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrailerModel(iso_639_1: $iso_639_1, iso_3166_1: $iso_3166_1, name: $name, key: $key, site: $site, size: $size, type: $type, official: $official, published_at: $published_at, id: $id)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'TrailerModel'))
      ..add(DiagnosticsProperty('iso_639_1', iso_639_1))
      ..add(DiagnosticsProperty('iso_3166_1', iso_3166_1))
...
abstract class _TrailerModel implements TrailerModel {
  const factory _TrailerModel(
      ...
      required final String id}) = _$TrailerModelImpl;
